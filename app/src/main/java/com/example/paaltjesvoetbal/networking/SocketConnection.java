...
/**
 * Wrapper for a Socket and implements reading messages that consist of a single line
 * from the socket.
...
public abstract class SocketConnection {
     ...
     */
    protected abstract void handleMessage(String message) throws IOException;
